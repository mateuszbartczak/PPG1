...
void RenderScene(void) {
	...
	m3dMatrixMultiply44(mViewProjectionMatrix, mFrustrum.GetProjectionMatrix(), mCameraMatrix);

	glUniformMatrix4fv(MVPMatrixLocation,1,GL_FALSE,mViewProjectionMatrix);
